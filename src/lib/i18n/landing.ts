...
const en: LandingText = {
  ...
  heroDesc: "MaktMakr generates, deploys, and optimizes your Meta ads every hour — until your target ROAS is reached. You set the goal. The AI runs the loop.",
  ctaStart: "Start Free",
  ctaHow: "See How It Works",
  stepsTitle: "The Optimization Loop",
  stepsDesc: "Connect once. MaktMakr handles generate → deploy → measure → iterate, 24/7.",
  steps: [
    { title: "Connect Meta", desc: "One-click Meta login. MaktMakr picks up your ad account, page, and pixel automatically." },
    { title: "AI Generates & Deploys", desc: "Claude writes the strategy, Gemini renders the creative, MaktMakr pushes it live to Meta with your targeting and budget." },
    { title: "Hourly Optimization", desc: "MaktMakr reads insights every hour, kills underperformers, scales winners, and regenerates creative until your ROAS goal is hit." },
  ],
  benefitsTitle: "Why marketers run MaktMakr on autopilot",
  benefits: [
  ...
  ctaTitle2: "Let MaktMakr run the loop.",
...
const ko: LandingText = {
  ...
  heroDesc: "MaktMakr가 광고를 생성하고, 배포하고, 1시간마다 지표를 읽어 목표 ROAS에 도달할 때까지 자동으로 최적화합니다. 당신은 목표만 정하세요.",
  ctaStart: "무료로 시작",
  ctaHow: "작동 방식 보기",
  stepsTitle: "최적화 루프",
  ...
  steps: [
    ...
    { title: "AI 생성 & 배포", desc: "Claude가 전략을 짜고 Gemini가 소재를 만들면, MaktMakr가 타겟·예산과 함께 메타에 바로 올립니다." },
    { title: "1시간 단위 자동 최적화", desc: "매시간 인사이트를 읽어 부진한 광고는 끄고, 잘 되는 건 키우고, 정체된 소재는 새로 생성합니다." },
  ],
  benefitsTitle: "마케터들이 MaktMakr를 자동화로 돌리는 이유",
  benefits: [
...
const ja: LandingText = {
  ...
  benefitsTitle: "クリエイターがMaktMakrを選ぶ理由",
  benefits: [
    "デザイン経験不要",
    "URLから広告画像まで1分以内",
    "高コンバージョンのAIコピー",
...
const zh: LandingText = {
  ...
  benefitsTitle: "创作者选择MaktMakr的理由",
  benefits: [
    "无需设计经验",
    "从URL到广告图片不到1分钟",
    "AI驱动的高转化文案",
