          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                stars: 5,
                quote: locale === "ko"
                  ? "에이전시한테 매달 내던 돈으로 Piped를 돌렸더니 CPA가 30% 떨어졌어요. 매시간 소재를 바꿔주는 게 진짜 차이를 만듭니다."
                  : "Replaced my agency retainer with Piped — CPA dropped 30% in two weeks. The hourly creative refresh is what actually moves the needle.",
              },
              {
              ...
              },
              {
                ...
                quote: locale === "ko"
                  ...
                  : "Set a target ROAS of 3, walked away. Piped gets there and pings me only when something needs my attention.",
              },
              {
              ...
              },
              {
                ...
                stars: 5,
                quote: locale === "ko"
                  ? "클라이언트 10곳 광고를 혼자 돌리는 데 Piped 없이는 불가능했을 거예요. 자동 생성 + 자동 최적화가 진짜."
                  : "Running ads for 10 clients solo would be impossible without Piped. Auto-generation plus auto-optimization is the unlock.",
              },
            ].map((testimonial, i) => (
